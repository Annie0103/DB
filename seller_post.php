...
<?php
    ...
    $sql = "SELECT * FROM post WHERE good_ID in (select good_ID from good where seller_ID='$seller_ID')";
	...
	<tr>
<h6 align="center"><a href="seller_index.php" target="_self" style="text-decoration:none;color:palevioletred"><font size="3">回到賣家頁面</font></a></h6>
    </tr>
	<?php } ?>
